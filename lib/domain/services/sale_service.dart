    ...
    for (final line in draft.lines) {
      ...
      await _store.putSaleItem(
        SaleItem(
          ...
          quantity: line.convertedPackageQuantity.toStorage(),
          unit: line.unit,
          unitPrice: line.unitPrice.toStorage(),
          lineTotal: line.lineTotal.toStorage(),
          selectedUnit: line.selectedUnit.storageValue,
          inputQuantity: line.inputQuantity.toStorage(),
      ...
      await _inventory.apply(
        session: session,
        productId: line.productId,
        quantity: line.convertedPackageQuantity,
        type: 'sale',
        referenceType: 'sale',
        referenceId: saleId,
      );
