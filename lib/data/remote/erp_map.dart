...
SaleItem saleItemFromMap(Map<String, dynamic> data, String id) {
  return SaleItem(
    ...
    selectedUnit: mapTextOrNull(data, const ['selected_unit', 'selectedUnit']),
    inputQuantity: mapTextOrNull(data, const ['input_quantity', 'inputQuantity']),
    inputUnit: mapTextOrNull(data, const ['input_unit', 'inputUnit']),
    version: mapVersion(data),
    deviceId: mapTextOrNull(data, const ['device_id', 'deviceId']),
    createdAt: mapDate(data, const ['created_at', 'createdAt']),
  );
